...
//     $link = "http://localhost:5173/verify-password-reset?link=$obj->userId&expires=$obj->expirationTimestamp&token=$obj->token";
    $link = "https://jessden.com/verify-password-reset?link=$obj->userId&expires=$obj->expirationTimestamp&token=$obj->token";
?>

@section("content")

    <h2>Reset Jessden Inventory System Password</h2>
