...
import {createOrganisation, updateOrganisation} from "../../../state/organisations/organisationsAction.ts";
...
const OrganisationForm: React.FC = () => {
    ...
    const onFinish = (values: any) => {
        ...
        ((state?.data && state?.data?.id)
            ? dispatch(updateOrganisation({ data: formData, id: state?.data?.id}))
    ...
    return (
        <TlaModal title={"Organisation"} loading={loading}> <br/>
