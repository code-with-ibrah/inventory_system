...
const AwardAwardOrganisationContestants: React.FC = (props: propsType) => {
    ...
    const filter = `awardId[eq]=${award.id}&isActive[eq]=1&isVerified[eq]=1`;
...
export default AwardAwardOrganisationContestants
