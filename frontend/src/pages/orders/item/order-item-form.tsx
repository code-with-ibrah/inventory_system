...
import OrderItemFormContent from "./order-item-form-content.tsx";
...
const OrderItemForm: React.FC = () => {
    ...
    return (
            <TlaDrawer title={"Order Items"} className="p-5">
            <Spin spinning={loading}>
                <div>
                    <OrderItemFormContent setLoading={setLoading} form={form}/>
