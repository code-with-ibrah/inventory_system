...
import GoodsReceiptFormContent from "./goods-receipt-form-content.tsx";

const GoodsReceiptItemForm: React.FC = () => {
    ...
    return (
            <TlaDrawer title={"Goods Receipt Items"} className="p-5">
            <Spin spinning={loading}>
                <div>
                    <GoodsReceiptFormContent setLoading={setLoading} form={form}/>
